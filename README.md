...
Além disso, estarei implementando uma ferramenta de IDS/IPS chamada Snort, que proporcionará uma camada adicional de segurança ao detectar e prevenir possíveis intrusões na rede.
...
Estarei adicionando os seguintes serviços: SSH, HTTP, HTTPS, DNS, um servidor DHCP, além de SFTP para transferências seguras de arquivos, uma ferramenta de monitoramento chamada Zabbix e um sistema de backup para garantir a proteção dos dados. 
